...
## 方块管理【2025.10.18-2025.10.22】

增加方块属性编辑器

![image-20251021203918764](README/image-20251021203918764.png)

![image-20251021203932936](README/image-20251021203932936.png)

实现单个方块的渲染，并且能够控制方块的渲染面

## 区块生成测试【2025.10.21】

![QQ20251021-203212](README/QQ20251021-203212.gif)



![QQ20251021-20365](README/QQ20251021-20365.gif)

对单区块的生成进行了测试，后续需要对Block的Mesh做合并与剔除的优化，减少渲染压力，其次就是对初次加载不会渲染的方块状态不更新。
